...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers("/api/posts/all", "/api/users/{userId}/postsCount", "/api/users/{userId}/followersCount", "/api/users/{userId}/makeAdmin", "/api/users/search", "api/analytics/posts-comments", "api/analytics/all").hasRole("ADMIN")
    ...
    CorsConfigurationSource corsConfigurationSource(){
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:4200","http://localhost:8080","http://localhost:8081","http://localhost:8082"));
